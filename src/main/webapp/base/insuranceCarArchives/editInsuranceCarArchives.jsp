...
<form id="insuranceCarArchivesEditForm">
	<table>
		<tr>
			<td>编号:</td>
			<td><input type="text" name="relcampId" readonly="readonly" style="background-color: #c0d8d8;"/></td>
			<td>简码:</td>
			<td><input type="text" id="insuranceCarArchives_edit_relcampJm" name="relcampJm" class="easyui-validatebox"   data-options="validType:'maxLength[100]'" /></td>
		</tr>
		<tr>
			<td>名称:</td>
			<td colspan="3" style="text-align: left;"><input type="text" id="insuranceCarArchives_edit_relcampName" name="relcampName" onkeyup="$('#insuranceCarArchives_edit_relcampJm').val(makePy($('#insuranceCarArchives_edit_relcampName').val()))" class="easyui-validatebox" data-options="required:true, missingMessage:'名称为必填项',validType:'maxLength[50]'" style="width: 282px;"/></td>
		</tr>
		<tr>
			<td>联系人:</td>
			<td><input type="text" name="relcampContact" /></td>
			<td>属性:</td>
			<td><input type="text" id="insuranceCarArchives_edit_attrId" name="attrId" class="easyui-combobox" data-options="
			url:'${pageContext.request.contextPath}/basRelationCampanyAction!findAllRelcampAttr.action',
			valueField:'id',   
    		textField:'text',
    		validType:'isSelected[\'#insuranceCarArchives_edit_attrId\']',
