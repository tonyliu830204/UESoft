...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/base/customArchives/customChange.js"></script>
<div class="easyui-layout" data-options="fit:true,border:false">
     ...
     <div data-options="region:'center',border:false" style="background:#eee;">
     	<fieldset>
    			...
    			<form id="customArchives_changeBeforeForm">
    				<table>
    					<tr>
    						<td>原客户代码:</td>
    						<td><input type="text" name="customId" readonly="readonly" style="width: 200px;background-color: #c0d8d8;"/></td>
    					</tr>
    					<tr>
    						<td>原客户名称:</td>
     	...
     	<fieldset>
    			...
    			<form id="customArchives_changeAfterForm">
    				<table>
    					<tr>
    						<td>新客户代码:</td>
    						<td><input type="text" name="customId" style="width: 200px"/></td>
    					</tr>
    					<tr>
    						<td>新客户名称:</td>
     ...
     <div data-options="region:'south',border:false" style="background:#eee;height: 90px; color: red;">
     	 &nbsp;&nbsp; 客户修改:<br/>
     	 &nbsp;&nbsp; 主要是客户档案编号的合并:<br/>
     	 &nbsp;&nbsp;&nbsp;(一)、如果同一客户在登记过程中，因为称呼不同造成客户名称重复，
     	 &nbsp;&nbsp;&nbsp;需要合并，在『更改为』输入框中输入合并后的客户档案编号。
     </div>
</div>