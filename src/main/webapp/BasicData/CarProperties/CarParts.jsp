...
<%@page import="com.syuesoft.model.BasCarParts"%>
...
<html>
	<head>
		...
		<title>My JSP 'CarParts.jsp' starting page</title>
	...
	<body>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/BasicData/CarProperties/CarParts.js"></script>
		<div id="cc" class="easyui-layout"
			...
			<div id="CarPartsCenter" region="center" style="background: #eee;" border="false">
