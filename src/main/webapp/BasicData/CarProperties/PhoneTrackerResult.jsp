...
<%@page import="com.syuesoft.model.BasCarPhonetrackerresult"%>
...
<html>
	<head>
		...
		<title>My JSP 'PhoneTrackerResult.jsp' starting page</title>
	...
	<body>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/BasicData/CarProperties/PhoneTrackerResult.js"></script>
		<div id="cc" class="easyui-layout"
			...
			<div id="PhoneTrackerResultCenter" region="center" style="background: #eee;" border="false">
