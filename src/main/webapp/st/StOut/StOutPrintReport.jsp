...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/st/StOut/StOutReport.jasper";//调用你通过ireport编译好的jasper文件即可。
	    File reportFile = new File(filepath);
//   			File reportFile2 = new File(this.getServletContext().getRealPath(
//		"/sell/foreordain/sellinstorehouse_subreport1.jasper"));//调用你通过ireport编译好的jasper文件即可。
		...
		String driver_n = bundleMessage.getString("connection.driver_class");
	   	...
	   	String stomId=request.getParameter("stomId");
	   	parameters.put("STOM_ID", stomId);
	   	parameters.put("SUBREPORT_DIR",tomcatpath+"/st/StOut/");
	   	try {
