...
<!-- 采购单管理-配件信息选择 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/st/StOut/StOut_AddPlanParts.js"></script>
<!-- 出库配件选择 --> 
	...
	<div data-options="region:'north',border:false" style="overflow:hidden;background:#eee;height:60px;">
	    	<form id="stout_selectplanpartsform" method="post">
				...
				<table>
					<tr>
						<td>工单号:</td>
						<td><input style="width:95px;" id="stout_addplanparts_receptionId"  name="receptionId"/></td>
						<td>车辆牌照</td>
