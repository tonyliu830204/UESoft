...
<html>
  <head>
    <title>My JSP 'stpurorder.jsp' starting page</title>
...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/st/StPurOrder/StPurOrder.jasper";
		...
		String orderId=request.getParameter("orderId");
	   	...
	   	parameters.put("SUBREPORT_DIR",tomcatpath+"st/StPurOrder/");
	   	try {
