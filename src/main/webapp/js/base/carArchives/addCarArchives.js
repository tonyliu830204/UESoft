								...
								$.ajax({
								   ...
								   success: function(r){
									 if(r.success){
										 ...
										 carArchives_add_customId.combogrid('setValues', [r.obj,$('#customArchives_add_customName').val()]);
/*										 carArchives_add_customId.combogrid('setValue', r.obj);
										 carArchives_add_customId.combogrid('setValue', $('#customArchives_add_customName').val());*/
		...
		var flag="<%=flag %>";
		if(flag==true){
			$('#carArchives_add_customId').combogrid({disabled:flag});
		}
	});
	//判断Vin号是否存在
