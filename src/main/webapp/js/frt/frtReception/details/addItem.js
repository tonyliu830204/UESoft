var flag=0;
	...
	var runs=function (){
		...
		$selectionItem.datagrid({
			...
			onDblClickRow : function(rowIndex, rowData){
				...
				copyDateAndBindEventAndTwo($selectedItem, index, rowData,receptionPrice);
		...
		$selectedItem.datagrid({
			...
			onClickRow : function (rowIndex, rowData){
				bindEnterInCloumn($selectedItem, rowIndex, 0);
			},
			onDblClickRow : function(rowIndex, rowData){
    ...
    function loadFrtWorkHour(){
    	$.ajax({
			type : 'post',
			url : 'baseAction!loadWorkHour.action',
			data : '',
			dataType : 'json',
			success : function(r){
                  $('#repitemSeries').combobox('setValue',r.whSortId);
                  $('#repitemSeries').combobox('seText',r.whSortName);
                  $('#repitemSeries').combobox('disabled',true);
   	        }
         });
    }