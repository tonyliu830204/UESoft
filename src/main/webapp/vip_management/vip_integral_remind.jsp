...
<html>
  ...
  <body class="easyui-layout" style="width:1000px;height:800px;" border="false" fit="true">
	<div data-options="region:'north',title:'查询条件'" style="height:110px;background:#eee;">
		<table>
			<tr>
    ...
    <div data-options="region:'center',title:'会员列表'" style="height:600px;">
    	<table id="Vip_integral_remind_id"></table>
    </div>
  </body>
</html>
