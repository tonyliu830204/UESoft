...
<!-- 车间管理-工单汇总 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtWorkshopManager/summary.js"></script>
<div class="easyui-layout" fit="true" border="false">
	<div region="north" id="search"
		style="overflow: hidden;padding:3px; background: #eee; height: 60px;"
		border="false">
		<form id="frtWorkshopManagerQueryForm">
			<table>
				<tr>
					<td>工单号:</td>
					...
					<td>车牌照:</td>
					<td><input type="text" id="frtWorkshopManager_summary_carId" name="carId" class="easyui-combobox"
					data-options="
					url : 'frtOptionsAction!findAllCarLicenseByReceptionIdAsCarLicense.action',
					valueField : 'id',
					textField : 'text',
					mode : 'remote'"/></td>
					<td>客户名称:</td>
					...
					<td>维修类别:</td>
					<td><input type="text" id="frtWorkshopManager_summary_reptId" name="reptId" class="easyui-combobox"
					data-options="
					mode : 'remote',
					url : 'frtOptionsAction!findAllReptype.action',
					validType:'isSelected[\'#frtWorkshopManager_summary_reptId\']',
					invalidMessage : '请从下拉框中选择维修类别',
					valueField:'id',  
					textField:'text' "/></td>
					<td>工单状态:</td>
					<td><input type="text" id="frtWorkshopManager_summary_receptionStatus" name="receptionStatus" class="easyui-combobox"
					data-options="
					url : 'frtOptionsAction!findBaseListData.action?key=<%=Contstants.DOCUMENT_TAG.DOCUMENTKEY %>',
					validType:'isSelected[\'#frtWorkshopManager_summary_receptionStatus\']',
	...
	<div id="frtWorkshopManagerSummaryCenter" region="center" style="background: #eee;" border="false">
		<table id="frtWorkshopManagerSummaryDatagrid"></table>
	</div>
</div>