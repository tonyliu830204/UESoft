...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		var f="<%=request.getParameter("flage")%>";
	</script>	
...
<%--			<div id="frtWorkshopManagerSummaryTab" data-options="fit:true,border:false,title:'工单汇总',href:'frt/frtWorkshopManager/summary.jsp'">--%>
<%--				--%>
<%--			</div>--%>
		     <div data-options="fit:true,border:false,title:'工单明细',href:'frt/frtWorkshopManager/details.jsp'">
		     </div>
		     </div>
	</div>
  </body>
