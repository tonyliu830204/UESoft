...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtWorkOrder/workOrderItem.js"></script>
  </head>
  ...
  <body>
    	<div class="easyui-layout" style="width:800px; height:600px" fit="true"
			...
			<div region="north" title="查询条件"
				...
				<div>
				    <privilege:enable code="COLLIGATE_SITEM_SEARCH">
					...
					<privilege:enable code="COLLIGATE_SITEM_CLEAR">
					...
					<privilege:enable code="COLLIGATE_SITEM_EXPROT">
					...
					<table>
						...
						<tr>
							...
							<td><input type="text" id="frtWorkOrderItemQueryCarId" name="carId" class="easyui-combobox"
								...
								mode : 'remote'"/></td>
							<td>维修项目:</td>
							<td colspan="2"><input type="text" id="frtWorkOrderItemQueryItemName" name="itemName" style="width:180px;" />
							</td>
							<!-- <td>结算单分类:</td>
