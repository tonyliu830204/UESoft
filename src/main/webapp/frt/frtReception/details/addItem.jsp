...
<!-- 前台接车-添加维修项目 -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtReception/details/addItem.js"></script>
<!-- 新增维修项目 -->
	    	...
	    	<form id="selectionItemForm" method="post">
				...
				<table>
					...
					<tr>
						...
						<td>工时分类:</td>
						<td><input type="text" id="repitemSeries" name="repitemSeries" class="easyui-combobox" data-options="
