...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtInsurePrize/details/rushToRepair.js"></script>
<!-- 抢修信息 -->
<form id="frtInsurePrizeRushToRepairForm" >
	<table align="left">
		<tr>
			<td>服务项目:</td>
