...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtInsurePrize/details/vehicleStructure.js"></script>
<!-- 车身状况(车辆结构) -->
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center',title:'车身状况'">
		<table id="frtInsurePrizeVehicleStructureDatagrid"></table>
	</div>
</div>
