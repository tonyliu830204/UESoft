...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtResevation/details/addCarArchives.js"></script>
<form id="carArchivesAddForm">
	<table width="100%">
    		...
    		onSelect:function(rec){
    			$(this).combobox('textbox').bind('keyup', function (){
    				if($('#carArchives_add_ctypeId').combobox('getValue') == '' || $('#carArchives_add_ctypeId').combobox('getValue') != $('#carArchives_add_ctypeId').combobox('getText')){
    					$('#carArchives_add_carCstlId').combobox('reload', 'frtOptionsAction!findCarStyle.action');
    				}
    			});  
	            $('#carArchives_add_carCstlId').combobox('clear');  
	            $('#carArchives_add_carCstlId').combobox('reload', 'frtOptionsAction!findCarStyle.action?ctypeId=' + rec.id);  
	        } "/></td>
			<td>车辆款式:</td>
		...
		<tr>
			...
			<td>固定电话:</td>
			<td><input type="text" id="carArchives_add_customTel2" name="customTel2" maxlength="20"
				 readonly="readonly" style="background-color: #c0d8d8;"/></td>
		</tr>
		<tr>
			<td>性别:</td>
		...
		<tr>
			...
			<td><input type="text" id="carArchives_add_customId_view" name="customId" maxlength="20" 
			 readonly="readonly" style="background-color: #c0d8d8;"/></td>
			<td>客户名称:</td>
			<td colspan="5"><input type="text" id="carArchives_add_customId" name="customName" maxlength="50"  style="width:520px;"/>
		</tr>
		<tr>
			 <td>动力系统:</td>
			<td>
