...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/frt/frtResevation/summary.js"></script>
<!-- 预约估价单汇总 -->
<div class="easyui-layout" fit="true" border="false">
	<div region="north" id="search"
		style="overflow: hidden;padding:3px; background: #eee; height: 90px;"
		border="false">
		<form id="frtResevationQueryForm">
			<table>
				<tr>
					<td>
					           预约登记:
					...
					<td>
					    <input type="text" name="carId" id="frtResevation_summary_carId"
					     class="easyui-combobox" 
				...
				<tr>
					...
					<td>
					   <input type="text" name="customName" id="customName"
					    ...
					    textField : 'text',
					    mode : 'remote',
					    onChange: function(rec){if(!rec){$('#customName').combobox('setValue','');}}"/>
					</td>
					<td>预约状态:</td>
					<td>
	...
	<div id="frtResevationSummaryCenter" data-options="region:'center',border:false" style="background:#eee;">
		<table id="frtResevationSummaryDatagrid"></table>
	</div>
</div>