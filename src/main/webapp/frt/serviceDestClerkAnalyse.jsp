  ...
  <body >
   	<div class="easyui-layout" fit="true" border="false">
		...
		<div region="center" style="background:#eee;" border="false">    
	  		<div id="serviceDestClerkAnalyseTabs" class="easyui-layout" fit="true"
				border="false">
				<div region="north" style="background:#eee;height:380px;" border="false" title="维修接待员分析数据">
					<div id="serviceDestClerkAnalyseDatagrid_center" style="height:100%;">
						<table id="serviceDestClerkAnalyseDatagrid"></table>
					</div>
				</div>
