...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/system_management/maintenance_traffic_analysis/serviceTimeAnalyze.js"></script>
  </head>
  <body>
  		 <div class="easyui-layout" style="width:800px; height:600px;" fit="true"
			border="false">
			 <div region="north"  split="false" style="height:70px;background: #eee;" border="false">
			    <privilege:enable code="GUESTANALY_TIME_SEARCH">
				    <a id='_search' href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="queryMaintenanceTrafficAnalysisServiceTimeAnalyze();">查询</a>
			   </privilege:enable>
				<privilege:enable code="GUESTANALY_TIME_CLEAR">
				    <a id='_clear' href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="_clear();">清空</a>
			   </privilege:enable>
			   <privilege:enable code="GUESTANALY_TIME_EXPORT">
				    <a id='_export' href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" onclick="_exceptMaintenanceTrafficAnalysisServiceTimeAnalyze();">Excel导出</a>
			   </privilege:enable>
			<br/>
			...
			<div region="center" style="background:#eee;" border="false">
				<div id="serviceTimeAnalyzeTabs" class="easyui-layout" fit="true"
					border="false">
					<div region="north" style="background:#eee;height:380px;" border="false" title="维修时间段分析数据">
						<div id="maintenanceTrafficAnalysis_serviceTimeAnalyze_center" style="height:100%;">
							<table id="maintenanceTrafficAnalysis_serviceTimeAnalyze"></table>
						</div>
					</div>
