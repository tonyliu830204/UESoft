...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/system_management/maintenance_traffic_analysis/servicingCarAnalyze.js"></script>
  </head>
  <body>
  		 <div class="easyui-layout" style="width:800px; height:600px;" fit="true"
			border="false">
			 <div region="north"  split="false" style="height:70px;background: #eee;" border="false">
			    <privilege:enable code="GUESTANALY_SERVICE_SEARCH">
				    <a id='_search' href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="queryMaintenanceTrafficAnalysisServicingCarAnalyze();">查询</a>
			   </privilege:enable>
				<privilege:enable code="GUESTANALY_SERVICE_CLEAR">
				    <a id='_clear' href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="_clear();">清空</a>
			   </privilege:enable>
			   <privilege:enable code="GUESTANALY_SERVICE_EXPORT">
				    <a id='_export' href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" onclick="_exceptMaintenanceTrafficAnalysisServicingCarAnalyze();">Excel导出</a>
			   </privilege:enable>
			<br/>
			...
			<div id="maintenanceTrafficAnalysis_servicingCarAnalyze_center" region="center" style="background:#eee;" border="false">
				<table id="maintenanceTrafficAnalysis_servicingCarAnalyze"></table>
			</div>
		</div>
  </body>
</html>