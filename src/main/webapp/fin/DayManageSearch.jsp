    	...
    	<div class="easyui-layout" data-options="fit:true,border:false">  
		    ...
		    <div data-options="region:'center',border:false" style="background:#eee;">
		    	...
		    	<div class="easyui-layout" style="width:800px; height:600px;" fit="true"
					border="false">
					<div region="north" style="background:#eee;height:380px;" border="false" title="日经营分析数据">
						<div id="dayManageSearchDatagrid_center" style="height:100%;">
							<table id="dayManageSearchDatagrid"></table>
						</div>
					</div>
