...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/fin/carBalanceUntangle.js"></script>
  </head>
  <body>
  <div class="easyui-layout" fit="true" border="false">
    <div data-options="region:'north',border:false" style="padding:1px;height:27px;overflow:hidden;background:#eee;">
       <privilege:enable code="FINANCECARBALANCE_SEARCH">
    	...
    	<privilege:enable code="FINANCECARBALANCE_CLEAR">
	...
	<div class="easyui-layout" fit="true" border="false">
		<div title="查询条件" style="overflow: hidden;background:#eee;height:60px;" data-options="region:'north',border:false">
			<form id="carBalanceUntangleQueryForm">
				<table>
					<tr>
						<td>结算时间:</td>
						<td>
						...
						<td>
						   <input type="text" name="customName"
						    class="easyui-combobox" 
						    data-options="url:'${pageContext.request.contextPath}/frtOptionsAction!findAllCustomAsCustomName.action',
						    valueField : 'id',
						    textField : 'text',
						    mode : 'remote'"/>
						</td>
		...
		<div id="carBalanceUntangleDatagrid_center" style="background:#eee;" data-options="region:'center',border:false">
			<table id="carBalanceUntangleDatagrid"></table>
		</div>
		</div>
	</div>
