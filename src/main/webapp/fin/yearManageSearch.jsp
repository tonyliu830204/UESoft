    ...
    <div data-options="region:'center',border:false" style="background:#eee;">
    	<div class="easyui-layout" data-options="fit:true,border:false">  
		    <div data-options="region:'north',title:'查询条件'" style="background:#eee;height:55px;">
		      <form id="yearManageQueryForm">
		        <table>
		           <tr>
		             <td>结算日期:</td>
		             <td>
		             	<input id="beginTime" name="beginTime"  style="width:140px;" class="Wdate"
						 onclick="WdatePicker({dateFmt:'yyyy',isShowToday:false,errDealMode:1,maxDate:'#F{$dp.$D(\'endTime\',{d:-1})}'})"/>
		                                              至<input id="endTime" name="endTime" style="width:140px;" class="Wdate"
		                 onclick="WdatePicker({dateFmt:'yyyy',isShowToday:false,errDealMode:1,minDate:'#F{$dp.$D(\'beginTime\',{d:0})}'})"/>
		             </td>
		    ...
		    <div data-options="region:'center',border:false" style="background:#eee;">
		    	...
		    	<div class="easyui-layout" style="width:800px; height:600px;" fit="true"
					border="false">
					<div region="north" style="background:#eee;height:380px;" border="false" title="年经营分析数据">
						<div id="yearManageSearchDatagrid_center" style="height:100%;">
							<table id="yearManageSearchDatagrid"></table>
						</div>
					</div>
