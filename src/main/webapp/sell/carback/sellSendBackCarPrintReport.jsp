...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/sell/carback/sellSendBackCar.jasper";//调用你通过ireport编译好的jasper文件即可。
		...
		String driver_n = bundleMessage.getString("connection.driver_class");
	   	...
	   	String retreatId=request.getParameter("retreatId");
	   	parameters.put("retreat_id", Integer.parseInt(retreatId));
	   	parameters.put("SUBREPORT_DIR",tomcatpath+"/sell/carback/");
	   	try {
