  ...
  <head>
    ...
    <script type="text/javascript">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" 
		 onclick="doFindforRecord($('#form_losed_customer_record_id'));" >查询</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#datagrid_losed_customer_record_id'),$('#form_losed_customer_record_id'));">清空</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-print" plain="true" id='_print' onclick=" _config('datagrid_losed_customer_record_id','datagrid_losed_customer_record_div')";  >打印</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick="doExport('datagrid_losed_customer_record_id','datagrid_losed_customer_record_div',_callbackExceptEight);" >导出</a>
		</div>
		<div region="center" style="background:#eee;"  border="false">
			...
			<div data-options="region:'north',collapsible : false" style="overflow: hidden;padding:3px; background:#eee; height:60px;" border="false">
				<form id="form_losed_customer_record_id">
				<fieldset>
					<legend>查询条件</legend>
				...
				<div id="datagrid_losed_customer_record_div" region="center" border="false" >
					<table id="datagrid_losed_customer_record_id"></table>
				</div>
			</div>
		</div>
	</div>	
