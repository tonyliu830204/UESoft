...
<html>
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/sell/selljs/unite_assay.js"></script>
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"  onclick="doFindbyCondition($('#form_teams_assay_id'),'dayReportAssayAction!doSellTeamsAssay.action','sellteamassay',$('#datagrid_unite_assay_id'),'销售班组');" >查询</a>

		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#form_teams_assay_id'));">清空</a>
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export'  onclick="doExport('datagrid_unite_assay_id','datagrid_unite_assay_div',_callbackExceptSix);" >导出</a>
