  ...
  <head>
    ...
    <script type="text/javascript">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" 
		 onclick="doFindbyCondition($('#datagrid_lose_bell_group_assay_id'),$('#form_lose_bell_group_assay_id'),'potentialcustomerAssayAction!getJFreeChartJpgOfLoseBellgroup.action','jfreemchart_lose_bell_group_id');" >查询</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#datagrid_lose_bell_group_assay_id'),$('#form_lose_bell_group_assay_id'),'potentialcustomerAssayAction!getJFreeChartJpgOfLoseBellgroup.action','jfreemchart_lose_bell_group_id');">清空</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-print" plain="true" id='_print' onclick=" _config('datagrid_lose_bell_group_assay_id','datagrid_lose_bell_group_assay_div')"; >打印</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick="doExport('datagrid_lose_bell_group_assay_id','datagrid_lose_bell_group_assay_div',_callbackExceptTwelve);" >导出</a>
		...
		<div region="center" style="background:#eee;"  border="false">
			...
			<div data-options="region:'north',collapsible : false" style="overflow: hidden;padding:3px; background:#eee; height:60px;" border="false">
				<form id="form_lose_bell_group_assay_id">
				<fieldset>
					<legend>查询条件</legend>
				...
				<div id="datagrid_lose_bell_group_assay_div" region="center" border="false" >
					<table id="datagrid_lose_bell_group_assay_id"></table>
				</div>
				...
				<div style="text-align: center;background-color: #C0C0C0;" fit="true">
					<img id="jfreemchart_lose_bell_group_id"  src="potentialcustomerAssayAction!getJFreeChartJpgOfLoseBellGroup.action"/>
				</div>
				</div>
			</div>
		</div>
