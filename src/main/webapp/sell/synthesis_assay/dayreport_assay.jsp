...
<html>
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/sell/selljs/unite_assay.js"></script>
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"  onclick="doFindbyCondition($('#form_dayreport_assay_id'),'dayReportAssayAction!doDayreportAssay.action','dayassay',$('#datagrid_dOrM_assay_id'),'销售日期');" >查询</a>

		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#form_dayreport_assay_id'));">清空</a>
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick="doExport('datagrid_dOrM_assay_id','datagrid_dOrM_assay_div',_callbackExceptOne);" >导出</a><!--
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick=";" >车辆上报</a>
		--></div>
		<div region="center" style="background:#eee;"  border="false">
			...
			<div data-options="region:'north',collapsible : false" style="overflow: hidden;padding:3px; background:#eee; height:120px;" border="false">
				<form id="form_dayreport_assay_id">
				<fieldset>
					<legend>查询条件</legend>
