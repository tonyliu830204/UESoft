...
<html>
  <head>
    ...
    <script type="text/javascript">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#form_carCu_id'));">清空</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-print" plain="true" id='_export'  onclick=" _config('carAndCustomList','carAndCustomList_div')" >打印</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick="carAndcustomExport();" >导出</a><!--
		...
		<div region="center" style="background:#eee;"  border="false">
			...
			<div data-options="region:'north',collapsible : false" style="overflow: hidden;padding:3px; background:#eee; height:120px;" border="false">
					...
					<table style="text-align: right">
			    		...
			    		mode:'remote',
					        ...
					        <td>代交及寄存:</td>
								...
								data-options="url:'${pageContext.request.contextPath}/baseTagAction!findBaseData.action?baseKey=<%=Contstants.BASE_SELL.BASE_CARTYPE%>',
								valueField:'id',  
								textField:'text',
								multiple:false ,
								mode:'remote'"
						...
						<td>分销商:</td>
							<td>
								...
								url : '${pageContext.request.contextPath}/sellUtilAction!findBussness.action',
								valueField:'id',  
								textField:'name',
								multiple:false,
								mode:'remote'  "
				...
				<div id="carAndCustomList_div" region="center" border="false" >
