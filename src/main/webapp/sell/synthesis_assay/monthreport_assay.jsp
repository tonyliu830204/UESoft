...
<html>
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/sell/selljs/unite_assay.js"></script>
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"  onclick="doFindbyCondition($('#form_monthreport_assay_id'),'dayReportAssayAction!doMonthreportAssay.action','monthassay',$('#datagrid_dOrM_assay_id'),'销售月份');" >查询</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#form_monthreport_assay_id'));">清空</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-print" plain="true" id='_print' onclick=" _config('datagrid_dOrM_assay_id','datagrid_dOrM_assay_div')"; >打印</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick="doExport('datagrid_dOrM_assay_id','datagrid_dOrM_assay_div',_callbackExceptTwo);" >导出</a>
		...
		<div region="center" style="background:#eee;"  border="false">
			...
			<div data-options="region:'north',collapsible : false" style="overflow: hidden;padding:3px; background:#eee; height:120px;" border="false">
				<form id="form_monthreport_assay_id">
				<fieldset>
					<legend>查询条件</legend>
						<table style="text-align: right">
						<tr>
							<td>销售日期:</td>
							<td><input type="text" class="Wdate" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'mxsSellDate2\',{d:-1})}','dateFmt':'yyyy-MM'})" name="xsSellDate" id="mxsSellDate" style="width: 85px;"/> 至 </td>
							<td><input type="text" class="Wdate" onclick="WdatePicker({minDate:'#F{$dp.$D(\'mxsSellDate\',{d:1})}','dateFmt':'yyyy-MM'})" name="xsSellDate2" id="mxsSellDate2" style="width: 85px;"/></td>
							<td>车辆品牌:</td>
				...
				<div id="datagrid_dOrM_assay_div" region="center" border="false" >
					<table id="datagrid_dOrM_assay_id"></table>
				</div>
			</div>
		</div>
	</div>	
