  ...
  <head>
    <title>销售方式分析</title>
     ...
     <script type="text/javascript" src="${pageContext.request.contextPath}/sell/selljs/unite_assay.js"></script>
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"  onclick="doFindbyCondition($('#form_sellway_assay_id'),'dayReportAssayAction!doSellwayAssay.action','sellwayassay',$('#datagrid_unite_assay_id'),'销售方式');" >查询</a>

		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#form_sellway_assay_id'));">清空</a>
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export' onclick="doExport('datagrid_unite_assay_id','datagrid_unite_assay_div',_callbackExceptThree);" >导出</a>
