...
<html>
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true"  onclick="doFindbyCondition($('#form_dept_assay_id'),'dayReportAssayAction!doDeptSellAssay.action','selldepart',$('#datagrid_unite_assay_id'),'销售部门');" >查询</a>
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id='_clear' onclick="doFormClear($('#form_dept_assay_id'));">清空</a>
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-export" plain="true" id='_export'  onclick="doExport('datagrid_unite_assay_id','datagrid_unite_assay_div',_callbackExceptFive);">导出</a>
