...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/sell/allocateManage/sellExchange.jasper";//调用你通过ireport编译好的jasper文件即可。
		...
		String driver_n = bundleMessage.getString("connection.driver_class");
	   	...
	   	String allocateId=request.getParameter("allocateId");
	   	parameters.put("allocate_id", Integer.parseInt(allocateId));
	   	  	parameters.put("SUBREPORT_DIR",tomcatpath+"/sell/allocateManage/");
	   	try {
