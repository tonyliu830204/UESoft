...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/sell/instoreOutQuery/queryInstoreOut.js"></script>
	<script type="text/javascript">
	var sgsm_d1;
		    	...
		    	<form id="carModelQueryForm" name="carModelQueryForm" method="post"  fit="true" >
							<table>
								 <tr>
									...
									&nbsp;&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" id="repyDateEnd" name="repyDateEnd" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'reDateStart\',{d:1})}'});"/></td>
									<td>供应商:</td>
								...
								<tr>
									<td>入库日期:</td>
									<td style="text-align: left;" colspan="3"><input type="text" id="instoreStart" name="instoreStart"  class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'instoreEnd\',{d:-1})}'});"/>
									&nbsp;&nbsp;&nbsp;&nbsp;至&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="instoreEnd" name="instoreEnd" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'instoreStart\',{d:1})}'});"/></td>
									<td>VIN号码:</td>
								...
								<tr>
									<td>退车单号:</td>
									<td><input type="text"  style="width: 110px" name="RetreatCode" id="instorehouseCode" /></td>
