...
<script type="text/javascript">
     ...
     $(function(){
			 ...
			 {title : '业务员',field : 'stf_Id',hidden:true,width : 100},
			 {title : '业务员',field : 'stf_Name',sortable:true,width : 100},
			 ...
			 {title : '客户等级',field : 'xs_Custom_Hide_Level',hidden:true,width : 100},
			 {title : '客户等级',field : 'xs_Custom_Hide_Level_Name',sortable:true,width : 100},
			 {title : '客户来源',field : 'xs_Custom_Source',hidden:true,width : 100},
			 {title : '客户来源',field : 'xs_Custom_Source_Name',sortable:true,width : 100},
			 {title : '证件号码',field : 'xs_Custom_Credentials',sortable:true,width : 150},
			 {title : '客户性质',field : 'xs_Custom_Property',hidden:true,width : 100},
			 {title : '客户性质',field : 'xs_Custom_Property_Name',sortable:true,width : 100},
