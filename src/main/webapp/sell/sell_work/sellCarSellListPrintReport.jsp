...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/sell/sell_work/sellCarSellList.jasper";//调用你通过ireport编译好的jasper文件即可。
		...
		String driver_n = bundleMessage.getString("connection.driver_class");
	   	...
	   	String xs_Car_Sel_Id=request.getParameter("xs_Car_Sel_Id");
	   	parameters.put("xs_car_sel_id", Integer.parseInt(xs_Car_Sel_Id));
	   	try {
