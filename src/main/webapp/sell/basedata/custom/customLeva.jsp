...
<html>
  ...
  <body class="easyui-layout">
   <script type="text/javascript">
	 	...
	 	<script type="text/javascript" src="${pageContext.request.contextPath}/sell/basedata/custom/customLeva.js"></script>
			 <div class="easyui-layout" data-options="fit:true, border: false">
			 	<div id="xi" region="north"  split="false" style="height:30px;background: #eee;" border="false">
					<a href="javascript:void(0);" class="easyui-linkbutton"  iconCls="icon-add" plain="true" onclick="addCustom();">新增</a>
					<a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="removeCustom()">删除</a>
				...
				<div region="center"  split="false" border="false">
					<div id="cc" class="easyui-layout" style="width:600px;height:500px;" fit="true" border="false">		
						<div data-options="region:'north',title:'查询条件'" style="overflow: hidden;padding:3px; background:#eee; height:56px;" border="false">
							<form id="customQueryForm" name="customQueryForm" method="post"  fit="true" >
								<table>
									 <tr>
										<!--<td>等级编码:</td>
										<td><input type="text" id="qLevaCode" name="levaC"  size="10" style="background-color: #c0d8d8;"/></td>
										--><td>等级名称:</td>
										<td><input type="text" id="qLevaName" name="levaN"  style="background-color:#c0d8d8;" /></td>
									</tr>
								</table>
							</form>
			   			</div>	   		
			   			<div id="customLeva_id" region="center" style="background:#eee;" border="false">
			   			 	<table id="customLeva" ></table>
			   			</div>   
					</div>	
		   		</div>
  	   </div>
