...
<html>
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/sell/analysis_by_synthesis/readyBill_query.js"></script>
					 ...
					 <div class="easyui-layout" style="width:1000px;height:800px;" border="false" fit="true">
						<div data-options="region:'north'" style="overflow: hidden;padding:1px; background:#eee; height:35px;" border="false">
						   ...
						   <tr>
							  ...
							  <td>预订单号:<input id="" name="account_Id" /></td>
							   <td>付款方式:</td>
							<td>
					...
					<div class="easyui-layout" style="width:1000px;height:800px;" border="false" fit="true">
						<div data-options="region:'north'" style="overflow: hidden;padding:1px; background:#eee; height:35px;" border="false">
						   ...
						   <table>
						   	<tr>
						   	<td>收款日期:</td>
								<td><input  type="text" class="Wdate" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'date2\',{d:-1})}'})" name="date_" id="date1" style="width: 85px;"/> 至 
								<input  type="text" class="Wdate" onclick="WdatePicker({minDate:'#F{$dp.$D(\'date1\',{d:1})}'})" name="date_two" id="date2" style="width: 85px;"/>
							 </td>  
						   		<td>客户姓名:<input  name="xs_Custom_Name" /></td>
							  <td>预订单号:<input id="" name="account_Id" /></td>
						   	</tr>
