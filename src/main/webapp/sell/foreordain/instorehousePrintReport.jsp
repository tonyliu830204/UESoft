...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/sell/foreordain/sellinstorehouse.jasper";//调用你通过ireport编译好的jasper文件即可。
		...
		String driver_n = bundleMessage.getString("connection.driver_class");
	   	...
	   	String instorehouseId=request.getParameter("instorehouseId");
	   	parameters.put("instorehouse_id", instorehouseId);
	   	parameters.put("SUBREPORT_DIR",tomcatpath+"/sell/foreordain/");
	   	try {
