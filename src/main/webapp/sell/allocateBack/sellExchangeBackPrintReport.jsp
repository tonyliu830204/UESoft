...
<body id="aaa" class="easyui-layout">
	  ...
	  <div id="StGoodsStorageReportDiv" region="center" style="background:#eee;">
	   <%
	    ...
	    String filepath =  tomcatpath+"/sell/allocateBack/selllExchangeBack.jasper";//调用你通过ireport编译好的jasper文件即可。
		...
		String driver_n = bundleMessage.getString("connection.driver_class");
	   	...
	   	parameters.put("back_id", Integer.parseInt(backId));
	   	parameters.put("SUBREPORT_DIR",tomcatpath+"/sell/allocateBack/");
	   	try {
